...
firmware images.
    ...
    - Speed. flashrom is often much faster than most vendor flash
      tools.
    - Portability. Supports Linux, FreeBSD, DragonFly BSD, Solaris,
      Mac OS X, and other Unix-like OSes.
...
EFI / coreboot / firmware z pliku.
    ...
    - Wspiera układy flash równoległe, LPC, SPI i FWH o różnych
      obudowach/wyprowadzeniach (DIP32, PLCC32, DIP8, SO8/SOIC8,
      TSOP32, TSOP40 i inne)
    - Nie potrzeba fizycznego dostępu, wystarczy dostęp do konta root.
    - Nie potrzebuje bootowalnej dyskietki, rozruchowego dysku CD-ROM
      lub innych nośników.
    - Nie potrzebne są klawiatura czy monitor. Wystarczy
      przeprogramować zdalnie poprzez SSH.
    - Nie ma potrzeby ponownego uruchamiania komputera. Zaprogramuj
      swój chip w uruchomionym systemie, zweryfikuj, bądź szczęśliwy.
      Nowy firmware będzie dostępny przy następnym bootowaniu.
    - Crossflashing i hotflashing jest możliwe tak długo, jak układy
      flash są elektrycznie i logicznie kompatybilne (ten sam
      protokół). Świetna metoda do przywracania sprzętu z źle
      zaprogramowanym firmware/BIOS.
